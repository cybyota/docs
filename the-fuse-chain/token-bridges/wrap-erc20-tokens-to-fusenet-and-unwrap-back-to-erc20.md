---
description: Steps to transfer/wrap CYB20 tokens from Ethereum to Fusenet
---

# Bridge for CYB20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/Yota explorer to relay the tokens.
