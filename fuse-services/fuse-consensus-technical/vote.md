...
Yota chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://cybyotascan.com/address/0x1c5ECaB05db92524118e7d95C45b3c121571834E) with the following params:
...
Some other useful functions on the [voting contract](https://cybyotascan.com/address/0x1c5ECaB05db92524118e7d95C45b3c121571834E) are:
