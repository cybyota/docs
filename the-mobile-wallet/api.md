...
The Yota Studio REST API for accessing the data and the services of the CYBYOTA network in a simple way. You can use this API to query and interact with the objects of the CYBYOTA network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and CYBYOTA network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Yota\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the CYBYOTA network |
...
| homeBridgeAddress | `String` | Bridge address on the CYBYOTA network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the CYBYOTA network |
...
Community is a set of contracts and services. Members of the community are users of the CYBYOTA network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the CYBYOTA network |
| homeTokenAddress | `String` | Address of the community token on the CYBYOTA network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the CYBYOTA network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the CYBYOTA network |
...
Entity is an account on the CYBYOTA network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on CYBYOTA network |
...
Tokens are compatible with the CYB20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
