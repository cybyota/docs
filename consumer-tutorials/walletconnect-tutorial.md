...
We will learn how to connect Yota cash wallet to various fuse DApps through WalletConnect feature and add liquidity to Fuseswap through Yota cash wallet.
...
Open your Yota cash wallet on your phone and the interface shown will be similar to the one shown in the image below.
...
Now click on “Pool” and then on “Add liquidity”. Select YOTA as your first token and fUSD as the second token from the dropdown. Enter the amount of YOTA you want to provide the liquidity for and the corresponding amount of fUSD that should be added will automatically show up according to the price of YOTA.  
...
Once the transaction is confirmed on-chain, click on “Supply” and approve the transaction. You will receive the liquidity pool tokens on your wallet which can be checked under tokens through [www.cybyotascan.com](http://www.cybyotascan.com/) on your wallet address.
