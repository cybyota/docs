...
We will learn how to connect Ledger to Metamask and use it on CYBYOTA network after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change to “CYBYOTA network” and perform the transactions on CYBYOTA network through your Ledger device.

Note: To learn how to add CYBYOTA network RPC follow [this link.](https://docs.cybyotascan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)
