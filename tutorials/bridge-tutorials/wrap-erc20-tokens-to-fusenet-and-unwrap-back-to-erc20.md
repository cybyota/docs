---
description: >-
  Steps to transfer/wrap CYB20 tokens from Ethereum to Fusenet and back using
  smart contracts.
---

# Using the bridge with CYB20 tokens directly through the contract

**Please use this tutorial at your own risk as it involves using Etherscan UI/Yota explorer to relay the tokens. This tutorial is applicable only for CYB20 tokens other than YOTA. Do not use this tutorial to transfer YOTA.** 
...
In the below example we will consider USDT \(CYB20\) and learn how to wrap USDT to Fusenet and relay it back to CYB20.
...
Once the transaction is confirmed on-chain we wait for 2 blocks to ensure security of transaction and then the USDT tokens should appear on your Yota address and have been swapped from Ethereum mainnet to Fusenet.

Now let’s learn how to transfer the wrapped CYB20 tokens on Fusenet back to Ethereum mainnet.
...
https://cybyotascan.com/address/0xFaDbBF8Ce7D5b7041bE672561bbA99f79c532e10/write\_proxy

![](../../.gitbook/assets/4%20%286%29.png)

Make sure that the network is YOTA network. If you have not added CYBYOTA network please follow the instructions [here](https://docs.cybyotascan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
[https://cybyotascan.com/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write\_proxy](https://cybyotascan.com/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write_proxy)
...
After the transaction is confirmed on CYBYOTA network, the bridge oracle will relay your tx on Ethereum. No need to wait for additional confirmations as Yota is PoS network. After sometime you should be able to see the successful transfer of the token on your CYB20 address.
